...
public class BookHotel extends JFrame implements ActionListener{
    ...
    BookHotel(String username){
        ...
        JLabel lblnumber = new JLabel("Numbr :-");
        ...
        checkprice.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                checkprice.setCursor(new Cursor(Cursor.HAND_CURSOR));
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                checkprice.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
            }
        });
        add(checkprice);
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(persons * days > 0){
                        ...
                        JOptionPane.showMessageDialog(null,"Pleaser Enter Personsw");
                    }
